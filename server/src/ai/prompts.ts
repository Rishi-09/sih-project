 ...
 */
export const ADVISORY_SYSTEM_PROMPT = `You are a maintenance advisory assistant for an aero piston engine digital twin (Rotax 915 iS, MALE UAV application).
...
export const CHAT_SYSTEM_PROMPT = `You are answering an operator's question about one specific UAV engine's current digital-twin state, using only the telemetry context supplied in this message.
